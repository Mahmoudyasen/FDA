...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    Empowering Health, Enriching Lives: Your Trusted Partner in Wellness. © 2024 All Rights Reserved.
    </p>
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      ...
      <li>
        <a className="text-gray-700 transition hover:text-gray-700/75" href="AllDoctors"> Doctors </a>
      </li>
